...
group by 
 ...
 select
    ...
    p.STAGE:user_id as ID_BUAP,
    count(ca.id) as Instructor_Login_Count,
   date_trunc('minute', min(ca.FIRST_ACCESSED_TIME)) as Instructor_First_Access,
